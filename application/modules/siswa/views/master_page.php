...
<html lang="en">
   <head>
      ...
      <title>Siswa - Portal Sekolah</title>
         ...
         <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item d-none d-sm-inline-block">
                  <a href="<?php echo site_url('siswa')?>" class="nav-link">Beranda</a>
               </li>
               <!-- li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2 main-menu">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <!-- <li class="nav-item">
                        <a href="<?php echo site_url('siswa/presensi')?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('siswa/profile/edit/' . $user_id)?>" class="nav-link">
                           <i class="nav-icon fas fa-user-edit"></i>
                           <p>Profil</p>
                        </a>
                     </li>
                      <li class="nav-item">
                        <a href="<?php echo site_url('siswa/ganti-password')?>" class="nav-link">
