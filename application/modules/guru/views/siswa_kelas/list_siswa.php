	...
	<table id="datatable" class="display" style="width:100%">
	    ...
	    <tbody>
			...
			<tr>
		       ...
		       <td>
		       	<a onclick="return confirm('anda yakin untuk menghapus data siswa dari kelas?')" href="<?php echo site_url('guru/hapus-siswa-kelas/' . simple_crypt($row['id'],'e') . '/' . simple_crypt($kelas_id,'e')  );?>" class="btn btn-danger" style="color:white"><i class="fas fa-trash-alt"></i></a></td>
		    </tr>	
			<?php } ?>                   
		</tbody>
	</table>
	  ...
	  ajax: {
	    ...
	    data: function (params) {
	      return {
	        ...
	        page: params.page,
	        sekolah_id : <?php echo $sekolah_id;?>
	      };
	    },
