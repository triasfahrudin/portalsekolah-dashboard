...
<html lang="en">
   <head>
      ...
      <title>Superuser - Portal Sekolah</title>
   ...
   <body class="hold-transition sidebar-mini">
      <div class="wrapper">
          ...
          <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item d-none d-sm-inline-block">
                  <a href="<?php echo site_url('superuser') ?>" class="nav-link">Beranda</a>
               </li>
               <!-- li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2 main-menu">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <a href="<?php echo site_url('superuser') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/jenis-dokumen') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/kelola-pengguna') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/kelola-skpd') ?>" class="nav-link">
                           <i class="nav-icon fas fa-users"></i>
                           <p>
                              SKDP
                           </p>
                     ...
                     <!-- <li class="nav-item">
                        <a href="<?php echo site_url('superuser/export-pns-pppk') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/bobot-presensi') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/jam-kerja') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/hari-libur') ?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/profile/edit/' . $user_id) ?>" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo site_url('superuser/ganti-password') ?>" class="nav-link">
                           <i class="nav-icon fas fa-lock"></i>
                           <p>Ganti Password</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="<?php echo site_url('superuser/settings') ?>" class="nav-link">
         ...
         <aside class="control-sidebar control-sidebar-dark">
            ...
            <div class="p-3">
               <h5>MENU</h5>
               <p><a href="<?php echo site_url('superuser/ganti-password') ?>">Ubah Password</a></p>
               <p><a href="<?php echo site_url('superuser/profile') ?>">Profile</a></p>
...
;?>
          ...
          <?php if ($this->uri->segment(2) === 'kelola-pengguna') {?>

            var field_kabupaten_id = [
               'kabupaten_id'
             ];

            filter_field(field_kabupaten_id,'close');
            var level = $('#field-level').val();
            const leveldinas = ['DINAS','DINAS-SMA','DINAS-SMK','DINAS-SLB']

            if(leveldinas.includes(level)){
               filter_field(field_kabupaten_id,'open');
            }else if(level === 'SUPERUSER'){
               filter_field(field_kabupaten_id,'close');
            }

            $('#field-level').on('change', function() {
                  var level = $('#field-level').val();
