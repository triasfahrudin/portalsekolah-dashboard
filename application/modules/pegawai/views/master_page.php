...
<html lang="en">
   <head>
      ...
      <title>Pegawai - Portal Sekolah</title>
   ...
   <body class="hold-transition sidebar-mini">
      <div class="wrapper">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2 main-menu">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                     <a href="<?php echo site_url('pegawai/dokumen') ?>" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo site_url('pegawai/pengajuan-izin')?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('pegawai/profile/edit/' . $user_id)?>" class="nav-link">
                           <i class="nav-icon fas fa-user-edit"></i>
                           <p>Profil</p>
                        </a>
                     </li>
                      <li class="nav-item">
                        <a href="<?php echo site_url('pegawai/ganti-password')?>" class="nav-link">
         ...
         <footer class="main-footer">
            ...
            <!-- Default to the left -->
             <font size="2" color="#2986CC">© 2024. Disdik Prov. Jambi</font>
         </footer>
      </div>
      <!-- ./wrapper -->
