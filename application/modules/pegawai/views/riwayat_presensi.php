		   	...
		   	<?php if(!empty($_POST)){ ?>
			    <?php 
			    	...
			    	<tr>
			    		...
			    		<td class="text-center"><?php echo $row['status_masuk'];?></td>
			    		<td class="text-center"><?php echo $row['status_pulang'];?></td>
			    		<td class="text-center"><?php echo $row['nilai_presensi'];?></td>
			    		<!-- <td>
			    			
			    		</td> -->
			    	</tr>
			    <?php $total += $row['nilai_presensi']; } ?>
			    <tr>
					<td colspan="3" class="text-right">Total Nilai Presensi</td>
