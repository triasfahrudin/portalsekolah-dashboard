   ...
   public function _page_output($output = null)
        ...
        try {
            ...
            if ($state === 'insert_validation') {
                ...
                if ($user_id_provided != $user_id) {
                    redirect(site_url('webview/siswa/profile/' . $token_login . '/edit/' . $user_id), 'reload');
                }
            }
    ...
    public function ganti_password()
    {
        ...
        if (!empty($_POST['pass_lama'])) {
            ...
            $cek_user = $this->db->get_where('siswa', array('id' => $user_id));
            ...
            if ($cek_user->num_rows() > 0) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if (empty($_POST['pass_baru']) || empty($_POST['pass_ulangi'])) {
                        ...
                        redirect(site_url('webview/siswa/ganti-password/' . $user_id), 'reload');
                    } else {
