...
<div class="row">
   <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/guru/profile/'. $token_login .'/edit/'. $user_id)?>">
   ...
   <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/guru/ganti-password/' . $token_login)?>">
   ...
   <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/guru/jadwal-mengajar/' . $index_param)?>">
            <img src="https://img.icons8.com/dusk/64/000000/training.png" class="figure-img img-fluid" />         
         </a>  
         <figcaption class="figure-caption text-center">Jadwal Mengajar</figcaption>
      </figure>
   </div>
   <!-- <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/guru/pengajuan-izin/' . $token_login)?>">
            <img src="https://img.icons8.com/dusk/64/000000/training.png" class="figure-img img-fluid" />         
         </a>  
         <figcaption class="figure-caption text-center">Pengajuan Izin</figcaption>
      </figure>
   </div> -->
