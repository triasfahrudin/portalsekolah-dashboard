...
<div class="row">
   <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/kepsek/profile/'. $token_login .'/edit/'. $user_id)?>">
   ...
   <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/kepsek/ganti-password/' . $token_login)?>">
   ...
   <!-- <div class="col text-center">
      <figure class="figure">
         <a href="<?php echo site_url('webview/kepsek/manage-ijin-guru')?>">
         <img src="https://img.icons8.com/dusk/64/000000/paper.png" class="figure-img img-fluid" />
         </a>  
         <figcaption class="figure-caption text-center">Ijin Pegawai</figcaption>
      </figure>
   </div> -->
	<!-- TODO: manage izin pegawai -->
</div>
