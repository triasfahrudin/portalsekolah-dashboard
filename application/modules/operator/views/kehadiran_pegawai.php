 	...
 	<div class="col-md-10">
 					...
 					<?php foreach ($presensi->result_array() as $row) { ?>
 						<tr>
 							...
 							<td>
 								...
 								<a href="<?php echo site_url('operator/download_presensi_pegawai/' . $row['id'] . '/' . $_POST['filter_tahun'] . '/' . $_POST['filter_bulan']) ?>" class="btn btn-success btn-sm" data-toggle="tooltip" title="Download">
 		...
 		<script type="text/javascript">
 			...
 			function detail_presensi(var_pegawai_id) {
 				$.ajax({
 					url: "<?php echo site_url('operator/detail-presensi-pegawai') ?>",
 					type: "post",
 					async: false,
 					dataType: 'json',
 					data: {
