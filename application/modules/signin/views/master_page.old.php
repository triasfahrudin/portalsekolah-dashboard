...
<head>
   <link rel="shortcut icon" href="https://disdiksungaipenuhkota.co.id/presensi/favicon.ico">
   <meta charset="utf-8">
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>PRESENSI ONLINE V.03</title>
      ...
      <div class="row">
         <div class="col-md-12">
            <nav class="navbar navbar-expand-lg navbar-dark bg-info" style="margin-bottom:15px">
               ...
               <a class="navbar-brand" href="http://disdiksungaipenuhkota.co.id/presensi">PRESENSI ONLINE</a>
                  ...
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="dropdown-item" onclick="Cookies.set('kabupaten_id', '')" href="<?php echo site_url('signin/get-pegawai-ultah') ?>">PNS Ulangtahun</a>
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form method="POST" action="<?php echo site_url('signin/index') ?>" id="form_login">
