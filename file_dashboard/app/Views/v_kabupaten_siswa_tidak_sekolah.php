...
<style>
    /*  */
    #tb_siswa_tidak_sekolah th:nth-child(2),
    #tb_siswa_tidak_sekolah td:nth-child(2) {
        width: 25% !important;
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    &nbsp; Siswa Tidak Sekolah &mdash; <?= $kabupaten_nama ?>
                </h4>
                <div class="table-responsive" id="table-container">
                    <table id="tb_siswa_tidak_sekolah" class="table align-middle table-bordered text-center">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            <?php foreach ($data_siswa as $kecamatan_id => $data): ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td>
                                        <a href="<?= base_url("/kecamatan_siswa_tidak_sekolah/$kecamatan_id") ?>">
                                            <?= $data['kecamatan_nama'] ?>
                                        </a>
                                    </td>
