...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    <a href="<?= base_url("/kecamatan_siswa_akhir/$kabupaten_id") ?>" class="btn btn-warning">Kembali</a>
                </h4>
                <div class="table-responsive" id="table-container">
                    <table id="tb_siswa" class="table align-middle table-bordered text-center">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            <?php foreach ($data_siswa as $sekolah_id => $data): ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= esc($data['sekolah_nama']) ?></td>
