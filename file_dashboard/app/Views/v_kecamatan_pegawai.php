...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    <a href="<?= base_url("/kabupaten_pegawai/$provinsi_id") ?>" class="btn btn-warning">Kembali</a>
                </h4>
                <div class="table-responsive" id="table-container">
                    <table id="tb_pegawai" class="table align-middle table-bordered text-center">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            <?php foreach ($data_pegawai as $kecamatan_id => $data): ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td>
                                        <a href="<?= base_url("/sekolah_pegawai/$kecamatan_id") ?>">
                                            <?= $data['kecamatan_nama'] ?>
                                        </a>
                                    </td>
